...
class MainWindow(QMainWindow):
    ...
    def click_photo(self):
        intext, ok = QInputDialog.getText(self,'Employee name','Please type employee name:- ')
        # time stamp
        ...
        # )))
        # custom_path = 'dataset'
        self.capture.capture(os.path.join(self.save_path, f"{intext}.jpg"))
